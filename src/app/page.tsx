...
export default function Home() {
  ...
  return (
    <div className="min-h-screen gradient-primary">
      {/* Header */}
      <header className="glass-dark border-b border-[#C0C8CA]/20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-[#C0C8CA] text-xs sm:text-sm">Find your next opportunity in eye care</p>
              </div>
            </div>
            <div className="hidden sm:flex items-center space-x-4 text-[#C0C8CA]">
      ...
      <main className="container mx-auto px-4 py-4 sm:py-8">
        ...
        {isLoading || isSearching ? (
          <div className="flex flex-col items-center justify-center py-16">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#AAB7B7] mb-4"></div>
            <p className="text-[#C0C8CA] text-lg">Searching for eye care facilities...</p>
          </div>
        ) : error ? (
          <div className="text-center py-16">
            <div className="glass rounded-xl p-8 max-w-md mx-auto">
              <div className="w-16 h-16 bg-[#2E4156]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Search className="w-8 h-8 text-[#2E4156]" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Search Error</h3>
              <p className="text-[#C0C8CA]">Unable to fetch facilities. Please try again.</p>
            </div>
          </div>
          ...
          <div className="text-center py-8 sm:py-16">
            <div className="glass rounded-xl p-6 sm:p-12 max-w-2xl mx-auto">
              ...
              <p className="text-[#C0C8CA] text-base sm:text-lg mb-6 sm:mb-8 max-w-lg mx-auto">
